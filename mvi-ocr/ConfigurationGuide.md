...
This solution explained how this customr solution can be use with MVI to recognize the brand and attempt to recognize the sub brand. We can also use Optical Character Recognition (OCR) solution if the confidence scores are low or if additional categorization is needed.
